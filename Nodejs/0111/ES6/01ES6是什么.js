...
它是在2015年6月正式发布
现在已经到了ES9(ES6~ES9) (ES5~ES7)

ECMAScript 和 JavaScript 是什么关系
ECMScript 是 JavaScript 的语言标准和规范
...
console.log(a_value)
console.log(b_value)
// 为了能解决 JS 的变量被提升的问题，也要觉得 全局和局部的概念
// ES6引入了新的变量声明方式 1.let 2.const
...
// ES6 中对String方法进行扩展
// hello world
// startWith() 表示参数字符串是否在源字符串的在指定位置
